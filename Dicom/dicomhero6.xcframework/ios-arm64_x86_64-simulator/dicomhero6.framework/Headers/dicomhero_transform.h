...

{
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(DicomheroImage*) allocateOutputImage:
            (DicomheroImage*)pInputImage
            width:(unsigned int)width
            height:(unsigned int)height
            error:(NSError**)pError DICOMHERO_NONNULL_ERROR;

    /// \brief Run the processing function of the DicomheroTransform.
    ///
    /// \param pInputImage the image to use as input
    ...
    /// \param pOutputImage  the object that will contain the processed image
    ...
    -(void) runTransform:
            ...
            outputImage:(DicomheroImage*)pOutputImage
