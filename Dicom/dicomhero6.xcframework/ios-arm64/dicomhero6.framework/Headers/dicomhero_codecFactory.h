...
///        object using one of the codecs supplied by the DICOMHERO library.
///
///////////////////////////////////////////////////////////////////////////////
@interface DicomheroCodecFactory: NSObject
    ...
    ///
    /// If none of the codecs supplied by DICOMHERO is able to decode the file's
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    +(DicomheroDataSet*)loadFromFile:(NSString*)fileName error:(NSError**)pError DICOMHERO_NONNULL_ERROR;
    ...
    ///
    /// \param fileName          the name of the input file
    /// \param maxBufferSize     the maximum size of the tags that are loaded
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    +(DicomheroDataSet*)loadFromFileMaxSize:(NSString*)fileName maxBufferSize:(unsigned int)maxBufferSize error:(NSError**)pError DICOMHERO_NONNULL_ERROR;

    /// \brief Parses the content of the input stream and returns a
    ///        DicomheroDataSet representing it.
    ///
    /// If none of the codecs supplied by DICOMHERO is able to decode the stream's
    /// content then sets the pError parameter and returns nil.
    ///
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    +(DicomheroDataSet*)loadFromStream:(DicomheroStreamReader*)pReader error:(NSError**)pError DICOMHERO_NONNULL_ERROR;
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    +(DicomheroDataSet*)loadFromStreamMaxSize:(DicomheroStreamReader*)pReader maxBufferSize:(unsigned int)maxBufferSize error:(NSError**)pError DICOMHERO_NONNULL_ERROR;
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    +(void)saveToFile:(NSString*)fileName dataSet:(DicomheroDataSet*) pDataSet codecType:(DicomheroCodecType) codecType error:(NSError**)pError DICOMHERO_NONNULL_ERROR;
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    +(void)saveToStream:(DicomheroStreamWriter*)pWriter dataSet:(DicomheroDataSet*)pDataSet codecType:(DicomheroCodecType) codecType error:(NSError**)pError DICOMHERO_NONNULL_ERROR;

    /// \brief Set the maximum image's width & height accepted by DICOMHERO.
    ///
    /// By default both the maximum width and height are set to 4096 pixels.
    ///
    /// \param maximumWidth      the maximum image's width accepted by DICOMHERO
    /// \param maximumHeight     the maximum image's height accepted by DICOMHERO
    ///
    ///////////////////////////////////////////////////////////////////////////////
