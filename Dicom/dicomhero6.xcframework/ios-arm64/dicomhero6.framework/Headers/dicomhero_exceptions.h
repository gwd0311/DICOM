...
@interface DicomheroDictionaryWrongPrivateTagError: DicomheroDictionaryError
@end
...
@interface DicomheroDataSetCannotAllocatePrivateTagError: DicomheroDataSetError
@end
