...
/// \enum DicomheroDicomVOIFunction
...

{
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(id)initWithCenter:(double)center width:(double)width function:(DicomheroDicomVOIFunction)function description:(NSString*)description;

    @property (readonly) double center;                      ///< The VOI window center.
    @property (readonly) double width;                       ///< The VOI window width.
    @property (readonly) DicomheroDicomVOIFunction function;    ///< The VOI function.
