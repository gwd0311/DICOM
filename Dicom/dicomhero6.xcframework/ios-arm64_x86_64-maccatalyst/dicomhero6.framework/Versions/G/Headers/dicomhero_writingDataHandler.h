...
@interface DicomheroWritingDataHandler: NSObject
{
    ...
    /// \brief Write a signed 64 bits integer.
    ///
    ...
    /// \brief Write a signed 32 bits integer.
    ///
    ...
    /// \brief Write a signed 16 bits integer.
    ///
    /// If the value cannot be converted from a signed long integer
    /// then set pError to DicomheroDataHandlerConversionError.
    ///
    ...
    /// \brief Write a signed 8 bits integer.
    ///
    /// If the value cannot be converted from a signed long integer
    /// then set pError to DicomheroDataHandlerConversionError.
    ///
    ...
    /// \brief Write an unsigned 64 bits integer.
    ///
    ...
    /// \brief Write an unsigned 16 bits integer.
    ///
    ...
    /// \brief Write an unsigned 8 bits integer.
    ///
    /// If the value cannot be converted from an unsigned long integer
    /// then set pError to DicomheroDataHandlerConversionError.
    ///
    ...
    /// \brief Write a person name.
    ///
    /// If the value cannot be converted to a person name
    /// then set pError to DicomheroDataHandlerConversionError.
    ///
    /// \param index the element number within the buffer. Must be smaller than
    ///        size()
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(void) setPersonName:(unsigned int)index newValue:(DicomheroPersonName*)value error:(NSError**)pError
        DICOMHERO_NONNULL_ERROR;
