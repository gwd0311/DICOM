...
@interface DicomheroDimseCommandBase: NSObject
{
   ...
   define_dicomhero_object_holder(DimseCommandBase);
    ...
    ///
    //////////////////////////////////////////////////////////////////
    -(DicomheroDataSet*)getCommandDataSet:(NSError**)pError DICOMHERO_NONNULL_ERROR;
    ...
    ///
    //////////////////////////////////////////////////////////////////
    -(DicomheroDataSet*)getPayloadDataSet:(NSError**)pError DICOMHERO_NONNULL_ERROR;
    ...
    ///
    //////////////////////////////////////////////////////////////////
    -(NSString*)getAffectedSopInstanceUid:(NSError**)pError DICOMHERO_NONNULL_ERROR;
    ...
    ///
    //////////////////////////////////////////////////////////////////
    -(NSString*)getAffectedSopClassUid:(NSError**)pError DICOMHERO_NONNULL_ERROR;
    ...
    ///
    //////////////////////////////////////////////////////////////////
    -(NSString*)getRequestedSopInstanceUid:(NSError**)pError DICOMHERO_NONNULL_ERROR;
    ...
    ///
    //////////////////////////////////////////////////////////////////
    -(NSString*)getRequestedSopClassUid:(NSError**)pError DICOMHERO_NONNULL_ERROR;
...
@interface DicomheroCFindResponse: DicomheroDimseResponse
    ...
    ///
    /// \param pReceivedCommand command for which the reponse is being
    ///                         constructed
    /// \param pIdentifier      one item from the C-FIND query results
    /// \return the object's ID
    ///
    //////////////////////////////////////////////////////////////////
...
@interface DicomheroCMoveResponse: DicomheroCPartialResponse
    ...
    /// \param warningSubOperations   number of C-STORE operations
    ///                               completed with warnings
    /// \param pIdentifier            DicomheroDataSet with the list of
...
@interface DicomheroDimseService: NSObject
{
   ...
   define_dicomhero_object_holder(DimseService);
    ...
    /// \param pError         set to an NSError derived class in case
    ///                       of error
    /// \return the negotiated transfer syntax for the specified
    ///         abstract syntax
    ///
    //////////////////////////////////////////////////////////////////
    -(NSString*)getTransferSyntax:(NSString*)abstractSyntax error:(NSError**)pError DICOMHERO_NONNULL_ERROR;
    ...
    ///
    //////////////////////////////////////////////////////////////////
    -(DicomheroDimseCommand*)getCommand:(NSError**)pError DICOMHERO_NONNULL_ERROR;
    ...
    ///
    //////////////////////////////////////////////////////////////////
    -(DicomheroCStoreResponse*)getCStoreResponse:(DicomheroCStoreCommand*)pCommand error:(NSError**)pError DICOMHERO_NONNULL_ERROR;
    ...
    ///
    //////////////////////////////////////////////////////////////////
    -(DicomheroCGetResponse*)getCGetResponse:(DicomheroCGetCommand*)pCommand error:(NSError**)pError DICOMHERO_NONNULL_ERROR;
    ...
    ///
    //////////////////////////////////////////////////////////////////
    -(DicomheroCFindResponse*)getCFindResponse:(DicomheroCFindCommand*)pCommand error:(NSError**)pError DICOMHERO_NONNULL_ERROR;
    ...
    ///
    //////////////////////////////////////////////////////////////////
    -(DicomheroCMoveResponse*)getCMoveResponse:(DicomheroCMoveCommand*)pCommand error:(NSError**)pError DICOMHERO_NONNULL_ERROR;
    ...
    ///
    //////////////////////////////////////////////////////////////////
    -(DicomheroCEchoResponse*)getCEchoResponse:(DicomheroCEchoCommand*)pCommand error:(NSError**)pError DICOMHERO_NONNULL_ERROR;
    ...
    ///
    //////////////////////////////////////////////////////////////////
    -(DicomheroNEventReportResponse*)getNEventReportResponse:(DicomheroNEventReportCommand*)pCommand error:(NSError**)pError DICOMHERO_NONNULL_ERROR;
    ...
    ///
    //////////////////////////////////////////////////////////////////
    -(DicomheroNGetResponse*)getNGetResponse:(DicomheroNGetCommand*)pCommand error:(NSError**)pError DICOMHERO_NONNULL_ERROR;
    ...
    ///
    //////////////////////////////////////////////////////////////////
    -(DicomheroNSetResponse*)getNSetResponse:(DicomheroNSetCommand*)pCommand error:(NSError**)pError DICOMHERO_NONNULL_ERROR;
    ...
    ///
    //////////////////////////////////////////////////////////////////
    -(DicomheroNActionResponse*)getNActionResponse:(DicomheroNActionCommand*)pCommand error:(NSError**)pError DICOMHERO_NONNULL_ERROR;
    ...
    ///
    //////////////////////////////////////////////////////////////////
    -(DicomheroNCreateResponse*)getNCreateResponse:(DicomheroNCreateCommand*)pCommand error:(NSError**)pError DICOMHERO_NONNULL_ERROR;
    ...
    ///
    //////////////////////////////////////////////////////////////////
    -(DicomheroNDeleteResponse*)getNDeleteResponse:(DicomheroNDeleteCommand*)pCommand error:(NSError**)pError DICOMHERO_NONNULL_ERROR;
