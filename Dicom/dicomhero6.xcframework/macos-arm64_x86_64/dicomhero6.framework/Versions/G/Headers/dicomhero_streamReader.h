...
/// DicomheroBaseStreamInput it manages: for instance this is used by the DICOMHERO
...

{
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(id)initWithInputStream:(DicomheroBaseStreamInput*)pInput virtualStart:(unsigned int)virtualStart virtualLength:(unsigned int)virtualLength;
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(DicomheroStreamReader*)getVirtualStream:(unsigned int)virtualSize error:(NSError**)pError DICOMHERO_NONNULL_ERROR;
