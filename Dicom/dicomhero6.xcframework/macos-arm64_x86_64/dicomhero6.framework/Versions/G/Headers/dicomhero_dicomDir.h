...

{
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(NSArray*)getFileParts:(NSError**)pError DICOMHERO_NONNULL_ERROR;

    -(NSString*)getTypeString:(NSError**)pError DICOMHERO_NONNULL_ERROR;

    /// \brief Set the next sibling entry (one the same depth level).
    ///
    /// \param pNextEntry the next sibling DicomheroDicomDirEntry object
    ...
    ///
    /// \param pFirstChildEntry the first child DicomheroDicomDirEntry object
    /// \param pError           set to a NSError derived class in case of error
    ///
    ///////////////////////////////////////////////////////////////////////////////
    ...
    ///
    /// \param pFileParts  a NSArray of NSString objects that form the name of the
...

{
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(id)initWithDataSet:(DicomheroDataSet*)pDataSet error:(NSError**)pError DICOMHERO_NONNULL_ERROR;
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(DicomheroDicomDirEntry*)getFirstRootEntry:(NSError**)pError DICOMHERO_NONNULL_ERROR;
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(DicomheroDicomDirEntry*)getNewEntry:(NSString*)recordType error:(NSError**)pError DICOMHERO_NONNULL_ERROR;
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(DicomheroDataSet*)updateDataSet:(NSError**)pError DICOMHERO_NONNULL_ERROR;
