...
@interface DicomheroVOILUT: DicomheroTransform
    ...
    /// \brief Initializer.
    ///
    /// \param lut the lookup table to use for the transform
    ...
    /// \param inputTopLeftX     the horizontal coordinate of the top-left angle of the
    ///                           area to analyze
    /// \param inputTopLeftY     the vertical coordinate of the top-left angle of the
    ///                           area to analyze
    /// \param inputWidth        the width of the area to analyze
    /// \param inputHeight       the height of the area to analyze
