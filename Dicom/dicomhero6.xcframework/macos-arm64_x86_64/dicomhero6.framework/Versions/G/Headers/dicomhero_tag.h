...

{
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(DicomheroWritingDataHandler*) getWritingDataHandler:(unsigned int) bufferId error:(NSError**)pError DICOMHERO_NONNULL_ERROR;
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(DicomheroWritingDataHandlerNumeric*) getWritingDataHandlerNumeric:(unsigned int) bufferId error:(NSError**)pError DICOMHERO_NONNULL_ERROR;
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(DicomheroWritingDataHandlerNumeric*) getWritingDataHandlerRaw:(unsigned int) bufferId error:(NSError**)pError DICOMHERO_NONNULL_ERROR;
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(DicomheroStreamWriter*) getStreamWriter:(unsigned int) bufferId error:(NSError**)pError DICOMHERO_NONNULL_ERROR;
    ...
    /// \param pStream     the file into which the tag's content is stored
    /// \param pError     set to a NSError derived class in case of error
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(void) setStream:(unsigned int)bufferId stream:(DicomheroFileStreamInput*)pStream error:(NSError**)pError DICOMHERO_NONNULL_ERROR;
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(DicomheroReadingDataHandler*) getReadingDataHandler:(unsigned int) bufferId error:(NSError**)pError DICOMHERO_NONNULL_ERROR;
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(DicomheroReadingDataHandlerNumeric*) getReadingDataHandlerNumeric:(unsigned int) bufferId error:(NSError**)pError DICOMHERO_NONNULL_ERROR;
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(DicomheroReadingDataHandlerNumeric*) getReadingDataHandlerRaw:(unsigned int) bufferId error:(NSError**)pError DICOMHERO_NONNULL_ERROR;
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(DicomheroStreamReader*) getStreamReader:(unsigned int) bufferId error:(NSError**)pError DICOMHERO_NONNULL_ERROR;
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(DicomheroDataSet*) getSequenceItem:(unsigned int) dataSetId error:(NSError**)pError DICOMHERO_NONNULL_ERROR;
