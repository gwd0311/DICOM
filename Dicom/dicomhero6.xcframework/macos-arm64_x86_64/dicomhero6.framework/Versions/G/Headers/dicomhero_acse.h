...
@interface DicomheroAssociationMessage: NSObject
{
    ...
    ///
    /// \param pDataSet a DicomheroDataSet to add to the message
    /// \param pError   a pointer to a NSError pointer which is set when an
    ///                  error occurs
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(void)addDataSet:(DicomheroDataSet*)pDataSet error:(NSError**)pError DICOMHERO_NONNULL_ERROR;
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(DicomheroDataSet*)getCommand:(NSError**)pError DICOMHERO_NONNULL_ERROR;
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(DicomheroDataSet*)getPayload:(NSError**)pError DICOMHERO_NONNULL_ERROR;
...
@interface DicomheroAssociationBase: NSObject
{
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(DicomheroAssociationMessage*)getCommand:(NSError**)pError DICOMHERO_NONNULL_ERROR;
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(DicomheroAssociationMessage*)getResponse:(unsigned int)messageId error:(NSError**)pError DICOMHERO_NONNULL_ERROR;
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(void)sendMessage:(DicomheroAssociationMessage*)pMessage error:(NSError**)pError DICOMHERO_NONNULL_ERROR;
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(void)release:(NSError**)pError DICOMHERO_NONNULL_ERROR;
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(void)abort:(NSError**)pError DICOMHERO_NONNULL_ERROR;
...
@interface DicomheroAssociationSCU: DicomheroAssociationBase
    ...
    ///                             - DicomheroCorruptedAcseMessageError
...
/// or set pError to DicomheroCorruptedAcseMessageError if the SCU sends a
/// wrong message type.
///
