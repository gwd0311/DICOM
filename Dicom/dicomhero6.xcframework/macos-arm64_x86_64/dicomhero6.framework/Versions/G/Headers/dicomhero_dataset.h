...
///
/// You can load a DicomheroDataSet from a DICOM file by using the
/// DicomheroCodecFactory::load() or you can create an empty dataset:
///
/// \code
/// NSError* error = nil;
...
/// \endcode
///
/// When creating an empty DicomheroDataSet you should specify the proper transfer
/// syntax in the init method.
///
/// To set the DicomheroDataSet's content, use one of the following methods:
/// - setImage()
/// - appendSequenceItem()
/// - setInt64()
/// - setInt32()
...

{
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(DicomheroTag*) getTag:(DicomheroTagId*)tagId error:(NSError**)pError DICOMHERO_NONNULL_ERROR;
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(DicomheroImage*) getImage:(unsigned int) frameNumber error:(NSError**)pError DICOMHERO_NONNULL_ERROR;
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(DicomheroOverlay*) getOverlay:(unsigned int) overlayNumber error:(NSError**)pError DICOMHERO_NONNULL_ERROR;
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(DicomheroImage*) getImageApplyModalityTransform:(unsigned int) frameNumber error:(NSError**)pError DICOMHERO_NONNULL_ERROR;
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(NSArray*) getVOIs:(NSError**)pError DICOMHERO_NONNULL_ERROR;
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(DicomheroDataSet*) getFunctionalGroupDataSet:(unsigned int)frameNumber error:(NSError**)pError DICOMHERO_NONNULL_ERROR;

    /// \brief Get a StreamReader connected to a buffer's data.
    ///
    /// \param tagId      the tag's id for which the StreamReader is required
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(DicomheroStreamReader*) getStreamReader:(DicomheroTagId*)tagId bufferId:(unsigned int)bufferId error:(NSError**)pError DICOMHERO_NONNULL_ERROR;
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(DicomheroDataSet*) getSequenceItem:(DicomheroTagId*)pTagId item:(unsigned int)itemId error:(NSError**)pError DICOMHERO_NONNULL_ERROR;
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(DicomheroLUT*) getLUT:(DicomheroTagId*)pTagId item:(unsigned int)itemId error:(NSError**)pError DICOMHERO_NONNULL_ERROR;
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(DicomheroReadingDataHandler*) getReadingDataHandler:(DicomheroTagId*)tagId bufferId:(unsigned int)bufferId error:(NSError**)pError DICOMHERO_NONNULL_ERROR;
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(DicomheroReadingDataHandlerNumeric*) getReadingDataHandlerNumeric:(DicomheroTagId*)tagId bufferId:(unsigned int)bufferId error:(NSError**)pError DICOMHERO_NONNULL_ERROR;
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(DicomheroReadingDataHandlerNumeric*) getReadingDataHandlerRaw:(DicomheroTagId*)tagId bufferId:(unsigned int)bufferId error:(NSError**)pError DICOMHERO_NONNULL_ERROR;
    ...
    ///
    /// If the tag's value cannot be converted to a signed 32 bits integer
    /// then sets pError to DicomheroDataHandlerConversionError.
    ///
    /// If the specified tag does not exist then set pError to
    /// DicomheroMissingTagError or DicomheroMissingGroupError.
    ...
    /// \param pError   a pointer to a NSError pointer which is set when an
    ///                  error occurs
    /// \return the tag's value as a signed long integer
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(signed int)getSignedLong:(DicomheroTagId*)tagId elementNumber:(unsigned int)elementNumber error:(NSError**)pError
        DICOMHERO_NONNULL_ERROR;

    /// \brief Retrieve a tag's value as signed 16 bits integer.
    ///
    /// If the tag's value cannot be converted to a signed 16 bits integer
    /// then sets pError to DicomheroDataHandlerConversionError.
    ///
    /// If the specified tag does not exist then set pError to
    /// DicomheroMissingTagError or DicomheroMissingGroupError.
    ...
    /// \param pError   a pointer to a NSError pointer which is set when an
    ///                  error occurs
    /// \return the tag's value as a signed 16 bits integer
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(signed short)getInt16:(DicomheroTagId*)tagId elementNumber:(unsigned int)elementNumber error:(NSError**)pError
        DICOMHERO_NONNULL_ERROR;

    /// \brief Retrieve a tag's value as signed 8 bits integer.
    ///
    /// If the tag's value cannot be converted to a signed 8 bits integer
    /// then sets pError to DicomheroDataHandlerConversionError.
    ///
    /// If the specified tag does not exist then set pError to
    /// DicomheroMissingTagError or DicomheroMissingGroupError.
    ...
    /// \brief Retrieve a tag's value as signed 64 bits integer.
    ///
    /// If the tag's value cannot be converted to a signed 64 bits integer
    /// then sets pError to DicomheroDataHandlerConversionError.
    ///
    ...
    /// \param pError   a pointer to a NSError pointer which is set when an
    ///                  error occurs
    /// \return the tag's value as a signed 64 bits integer
    ///
    ///////////////////////////////////////////////////////////////////////////////
    ...
    /// \brief Retrieve a tag's value as signed 32 bits integer.
    ///
    /// If the tag's value cannot be converted to a signed 32 bits integer
    /// then sets pError to DicomheroDataHandlerConversionError.
    ///
    ...
    /// \brief Retrieve a tag's value as unsigned 64 bits integer.
    ///
    /// If the tag's value cannot be converted to an unsigned 64 bits integer
    /// then sets pError to DicomheroDataHandlerConversionError.
    ///
    /// If the specified tag does not exist then set pError to
    /// DicomheroMissingTagError or DicomheroMissingGroupError.
    ...
    /// \brief Retrieve a tag's value as unsigned 32 bits integer.
    ///
    /// When calling getUint32() on an AT tag (Attribute Tag) then the tag group
    /// is always in the high word of the returned value.
    ///
    /// If the tag's value cannot be converted to an unsigned 32 bits integer
    /// then sets pError to DicomheroDataHandlerConversionError.
    ///
    /// If the specified tag does not exist then set pError to
    /// DicomheroMissingTagError or DicomheroMissingGroupError.
    ...
    /// \brief Retrieve a tag's value as unsigned 16 bits integer.
    ///
    /// If the tag's value cannot be converted to an unsigned 16 bits integer
    /// then sets pError to DicomheroDataHandlerConversionError.
    ///
    /// If the specified tag does not exist then set pError to
    /// DicomheroMissingTagError or DicomheroMissingGroupError.
    ...
    /// \brief Retrieve a tag's value as unsigned 8 bits integer.
    ///
    /// If the tag's value cannot be converted to an unsigned 8 bits integer
    /// then sets pError to DicomheroDataHandlerConversionError.
    ///
    /// If the specified tag does not exist then set pError to
    /// DicomheroMissingTagError or DicomheroMissingGroupError.
    ...
    /// \brief Deprecated. Use getUint32() instead.
    ///
    /// When calling getUnsignedLong() on an AT tag (Attribute Tag) then the tag
    /// group is always in the high word of the returned value.
    ///
    /// If the tag's value cannot be converted to an unsigned 32 bits integer
    /// then sets pError to DicomheroDataHandlerConversionError.
    ///
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(NSString*)getString:(DicomheroTagId*)tagId elementNumber:(unsigned int)elementNumber defaultValue:(NSString*)defaultValue error:(NSError**)pError DICOMHERO_NONNULL_ERROR;

    /// \brief Retrieve a tag's value as a DicomheroPersonName object.
    ///
    /// If the tag's value cannot be converted to a DicomheroPersonName
    /// then sets pError to DicomheroDataHandlerConversionError.
    ///
    /// If the specified tag does not exist then set pError to
    /// DicomheroMissingTagError or DicomheroMissingGroupError.
    ...
    /// \param pError   a pointer to a NSError pointer which is set when an
    ///                  error occurs
    /// \return the tag's value as a DicomheroPersonName object
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(DicomheroPersonName*) getPersonName:(DicomheroTagId*)tagId elementNumber:(unsigned int)elementNumber error:(NSError**)pError DICOMHERO_NONNULL_ERROR;
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(DicomheroPersonName*) getPersonName:(DicomheroTagId*)tagId elementNumber:(unsigned int)elementNumber defaultValue:(DicomheroPersonName*)defaultValue error:(NSError**)pError DICOMHERO_NONNULL_ERROR;
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(DicomheroAge*)getAge:(DicomheroTagId*)tagId elementNumber:(unsigned int)elementNumber error:(NSError**)pError DICOMHERO_NONNULL_ERROR;
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(DicomheroAge*)getAge:(DicomheroTagId*)tagId elementNumber:(unsigned int)elementNumber defaultValue:(DicomheroAge*)defaultValue error:(NSError**)pError DICOMHERO_NONNULL_ERROR;
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(DicomheroDate*)getDate:(DicomheroTagId*)tagId elementNumber:(unsigned int)elementNumber error:(NSError**)pError DICOMHERO_NONNULL_ERROR;
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(DicomheroDate*)getDate:(DicomheroTagId*)tagId elementNumber:(unsigned int)elementNumber defaultValue:(DicomheroDate*)defaultValue error:(NSError**)pError DICOMHERO_NONNULL_ERROR;

    /// \brief Retrieve a tag's value as an DicomheroPersonName object.
    ///
    /// If the tag's value cannot be converted to an DicomheroPersonName object
    /// then sets pError to DicomheroDataHandlerConversionError.
    ///
    /// If the specified tag does not exist then set pError to
    /// DicomheroMissingTagError or DicomheroMissingGroupError.
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(DicomheroPersonName*)getPersonName:(DicomheroTagId*)tagId elementNumber:(unsigned int)elementNumber defaultValue:(DicomheroPersonName*)defaultValue error:(NSError**)pError
        DICOMHERO_NONNULL_ERROR;
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(DicomheroTag*) getTagCreate:(DicomheroTagId*)tagId tagVR:(DicomheroTagType)tagVR error:(NSError**)pError
        DICOMHERO_NONNULL_ERROR;
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(DicomheroTag*) getTagCreate:(DicomheroTagId*)tagId error:(NSError**)pError
        DICOMHERO_NONNULL_ERROR;
    ...
    /// \param bufferId   the id of the buffer for which the StreamWriter is
    ///                    required. This parameter is usually 0
    /// \param tagVR      VR used when creating a new tag
    /// \param pError   set to a NSError derived class in case of error
    /// \return           the StreamWriter connected to the buffer's data.
    ///
    ///////////////////////////////////////////////////////////////////////////////
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(DicomheroDataSet*) appendSequenceItem:(DicomheroTagId*)pTagId error:(NSError**)pError
        DICOMHERO_NONNULL_ERROR;
    ...
    /// \brief Write a new DicomheroPersonName value into the element 0 of the
    ///        specified tag's buffer 0.
    ///
    /// If the specified tag doesn't exist then a new tag is created using
    /// the data type (VR) PN.
    ///
    /// If the new value cannot be converted to a person name then sets pError to
    /// DicomheroDataHandlerConversionError.
    ///
    /// \param tagId    the tag's id
    /// \param newValue the value to write into the tag
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(void)setPersonName:(DicomheroTagId*)tagId newValue:(DicomheroPersonName*)newValue error:(NSError**)pError
        DICOMHERO_NONNULL_ERROR;

    /// \brief Before writing a relocatable private tag you have to reserve its
    ///        element id inside the group.
    ///
    /// This method will cause Dicomhero to reserve a range of addresses for
    /// your private tags and will return the actual address in which your
    /// private tag must be written.
    ///
    /// \param tagId the private relocatable tag id (the group must be an odd
    ///              number, the element id must be less than 0x100
    /// \param creatorName the owner of the private tag (usually your company name
    ///                    or an unique identifier for your company name)
    /// \param pError set to DicomheroDataSetCannotAllocatePrivateTagError
    ///                if the tag cannot be allocated because all the slots have
    ///                been taken,
    ///               DicomheroDictionaryWrongPrivateTagError if the tag id
    ///                contains wrong values
    /// \return the actual tag id to use when writing the private tag
    ///
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(DicomheroTagId*)allocatePrivateTag:(DicomheroTagId*)tagId creatorName:(NSString*)creatorName error:(NSError**)pError
        DICOMHERO_NONNULL_ERROR;

    /// \brief Before reading a relocatable private tag you have to find its
    ///        element id inside the group.
    ///
    /// This method will look for the actual tag element id inside the group.
    ///
    /// \param tagId the private relocatable tag id (the group must be an odd
    ///              number, the element id must be less than 0x100
    /// \param creatorName the owner of the private tag (usually your company name
    ///                    or an unique identifier for your company name)
    /// \param pError set to DicomheroDictionaryWrongPrivateTagError if the tag id
    ///                contains wrong values
    /// \return the actual tag id to use when reading the private tag
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(DicomheroTagId*)findPrivateTag:(DicomheroTagId*)tagId creatorName:(NSString*)creatorName error:(NSError**)pError
        DICOMHERO_NONNULL_ERROR;
