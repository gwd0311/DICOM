...

{
    ...
    /// connections.
    ///
    /// \param pAddress the address to which the listening socket must be bound
    /// \param pError   set to a NSError derived class in case of error
    /// \return the object's ID
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(id)initWithAddress:(DicomheroTCPPassiveAddress*)pAddress error:(NSError**)pError DICOMHERO_NONNULL_ERROR;
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    -(DicomheroTCPStream*)waitForConnection:(NSError**)pError DICOMHERO_NONNULL_ERROR;
